...
function draw() {
    ...
    stroke(255);
    strokeWeight(8);
    //Kodun surekli calisip rasgele degerler uretmesini engeller
    noLoop();
    ...
    //Loop Başlangıç Bu Loop 50 ile canvasın sonu arasında 50'şer artarak y değerleri oluşturur.
    //y degerleri cizgiler arasindaki mesafeyi belirler
